...
module.exports = {
  ...
  'get /v2/widgets/:widgetName/:a/:b/:c/:d': 'widget.staticFile',
  'get /v2/widgets/:widgetName/:a/:b/:c': 'widget.staticFile',
  'get /v2/widgets/:widgetName/:a/:b': 'widget.staticFile',
  'get /v2/widgets/:widgetName/:a': 'widget.staticFile',  
  'get /v2/widgets/:widgetName': 'widget.home',
}
